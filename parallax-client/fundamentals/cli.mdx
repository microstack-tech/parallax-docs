...
The Parallax client is primarily controlled using the command line. The Parallax client is started using the `prlx` command. It is stopped by pressing ctrl-c.

You can configure the Parallax client using command-line options (a.k.a. flags). The Parallax client also has sub-commands, which can be used to invoke functionality such as the console or blockchain import/export.

The command-line help listing is reproduced below for your convenience. The same information can be obtained at any time from your own Parallax client instance by running:
...
```
NAME:
   prlx - the Prlx command line interface

   Copyright 2013-2022 The go-ethereum Authors
   Copyright 2025 Microstack

USAGE:
   prlx [options] [command] [command options] [arguments...]

VERSION:
   0.1.1-stable-d9425677
...
COMMANDS:
   ...
   makecache                          Generate XHash verification cache (for testing)
   makedag                            Generate XHash mining DAG (for testing)
   ...
   wallet                             Manage Parallax presale wallets
...
PARALLAX OPTIONS:
  ...
  --networkid value                   Explicitly set network id (integer)(For testnet: use --testnet instead) (default: 2110)
  --syncmode value                    Blockchain sync mode ("snap", "full" or "light") (default: snap)
  --exitwhensynced                    Exits after block synchronisation completes
  --gcmode value                      Blockchain garbage collection mode ("full", "archive") (default: "full")
  --txlookuplimit value               Number of recent blocks to maintain transactions index for (default = about one year, 0 = entire chain) (default: 52560)
  ...
  --mainnet                           Parallax mainnet
  --testnet                           Testnet: pre-configured proof-of-work test network
  --datadir value                     Data directory for the databases and keystore (default: "/home/andrepatta/.parallax")
  --datadir.ancient value             Data directory for ancient chain segments (default = inside chaindata)
  --remotedb value                    URL for remote database

LIGHT CLIENT OPTIONS:
  --light.serve value                 Maximum percentage of time allowed for serving LPS requests (multi-threaded processing allows values over 100) (default: 0)
...
XHASH OPTIONS:
  --xhash.cachedir value             Directory to store the XHash verification caches (default = inside the datadir)
  --xhash.cachesinmem value          Number of recent XHash caches to keep in memory (16MB each) (default: 2)
  --xhash.cachesondisk value         Number of recent XHash caches to keep on disk (16MB each) (default: 3)
  --xhash.cacheslockmmap             Lock memory maps of recent XHash caches
  --xhash.dagdir value               Directory to store the XHash mining DAGs (default: "/home/andrepatta/.xhash")
  --xhash.dagsinmem value            Number of recent XHash mining DAGs to keep in memory (1+GB each) (default: 1)
  --xhash.dagsondisk value           Number of recent XHash mining DAGs to keep on disk (1+GB each) (default: 2)
  --xhash.dagslockmmap               Lock memory maps for recent XHash mining DAGs
...
TRANSACTION POOL OPTIONS:
  ...
  --txpool.accountslots value         Minimum number of executable transaction slots guaranteed per account (default: 32)
  --txpool.globalslots value          Maximum number of executable transaction slots for all accounts (default: 10240)
  --txpool.accountqueue value         Maximum number of non-executable transaction slots permitted per account (default: 128)
...
NETWORKING OPTIONS:
  ...
  --port value                        Network listening port (default: 32110)
...
MINER OPTIONS:
  ...
  --miner.gaslimit value              Target gas ceiling for mined blocks (default: 600000000)
  --miner.coinbase value              Public address for block mining rewards (default = first account) (default: "0")
...
METRICS AND STATS OPTIONS:
  ...
  --metrics.influxdb.database value      InfluxDB database name to push reported metrics to (default: "prlx")
  ...
  --metrics.influxdb.bucket value        InfluxDB bucket name to push reported metrics to (v2 only) (default: "prlx")
  --metrics.influxdb.organization value  InfluxDB organization name (v2 only) (default: "prlx")
