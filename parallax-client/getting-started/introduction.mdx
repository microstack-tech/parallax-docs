...
```sh
clef --keystore parallax-tutorial/keystore --configdir parallax-tutorial/clef --chainid 2111
```
...
INFO [02-10|13:55:30.947] Starting signer                          chainid=2111 keystore=parallax-tutorial/keystore light-kdf=false advanced=false
