...
Clef listens to HTTP requests on http.addr:http.port (or to IPC on ipcpath), with the same JSON-RPC standard as the Parallax client. The messages are expected to be [JSON-RPC 2.0 standard](https://www.jsonrpc.org/specification).
...
See the [external API changelog](https://github.com/microstack-tech/parallax/blob/main/cmd/clef/extapi_changelog.md) for up to date information about changes to this API.
...
* content type \[string]: type of signed data
  ...
  * text/plain: simple hex data validated by account\_ecRecover
...
### **ApproveListing / ui\_approveListing**
...
### **ApproveSignData / ui\_approveSignData**
...
### **ApproveNewAccount / ui\_approveNewAccount**
...
### **OnSignerStartup / ui\_onSignerStartup**
...
### **OnInputRequired / ui\_onInputRequired**
