...
For use-cases which depend on several JSON-RPC endpoints the batching approach can get easily complicated. In that case the Parallax client offers a [GraphQL API](../graph-ql-server) which is more suitable.
