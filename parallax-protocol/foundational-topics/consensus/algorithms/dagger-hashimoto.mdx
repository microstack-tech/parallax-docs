...
To better understand this page, we recommend you first read up on [proof-of-work](../proof-of-work) consensus, [mining](../mining), and [mining algorithms](./overview).
