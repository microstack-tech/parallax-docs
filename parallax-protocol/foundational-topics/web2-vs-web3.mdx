...
* Payments are built in via the native token, LAX. Payments being intrinsically built into the evolution of the internet is an intrinsic benefit because of reduced costs, decentralization, transparency, security, uniformity, programmability, customisability etc. This is in contrast to web2, where payments mechanisms are extrinsic to the base layer of the internet
* Parallax is turing-complete, meaning you can program pretty much anything.
...
| Servers for gig-economy apps could go down and affect worker income        | Parallax, a decentralized network of 1000s of computers can serve information relating to decentralized applications at any time.most |
...
* Cost – most successful dapps put very small portions of their code on the blockchain as it can be expensive because there is a lot of information to write to the PVM, and also when there is competition for making deployments on chain, costs are driven higher.
