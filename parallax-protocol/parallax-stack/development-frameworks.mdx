...
Before diving into frameworks, we recommend you first read through our introduction to [dapps](../foundational-topics/introduction-to-dapps.md) and the [Parallax stack](./introduction-stack).
...
* [Set up a local development environment](../../parallax-client/getting-started/installing-client)
