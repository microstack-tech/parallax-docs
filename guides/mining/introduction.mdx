...
👉 Begin with [Mining with the CPU Miner](./mining-with-the-parallax-cpu-miner) to quickly try mining on your own machine. From there, you can explore GPU and pool mining for better results.
